      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <span className="text-white font-medium">
            Delivering Purity and Packaging Since 2015
          </span>
        </div>

        {/* Main Heading */}
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-8 leading-tight">
          <span className="text-white">Bottling &</span>
          <span
        ...
        <p className="text-xl sm:text-2xl text-gray-300 mb-12 leading-relaxed max-w-4xl mx-auto">
          Eco-friendly packaging solutions across East Africa - delivering pure
          water with sustainable, recycled materials for healthier communities.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 text-center">
          ...
          <div className="group cursor-pointer">
            ...
            <div className="text-gray-300 text-lg">
              Sustainably Recycled Plastic Solutions
            </div>
          </div>
        </div>
      </div>
