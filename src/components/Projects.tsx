...
const Products: React.FC = () => {
  ...
  const products = [
    {
      ...
      title: 'PET Preforms',
      category: 'preforms',
      image: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=800&h=600',
      description: 'High-quality PET preforms in various weights and neck configurations',
    ...
    },
    {
      ...
      title: 'PET Bottles',
      category: 'bottles',
      image: 'https://images.unsplash.com/photo-1559181567-c3190ca9959b?auto=format&fit=crop&w=800&h=600',
    ...
    },
    {
      ...
      category: 'water',
      image: 'https://images.unsplash.com/photo-1550572017-edd951aa8ca9?auto=format&fit=crop&w=800&h=600',
    ...
    {
      id: 4,
      title: 'Intore Drinking Water',
      category: 'water',
      image: 'https://images.unsplash.com/photo-1616122793020-2e5d4a98c7c7?auto=format&fit=crop&w=800&h=600',
      description: 'Pure and refreshing water for everyday hydration needs',
      specifications: '300ml, 600ml, and 2L',
      options: 'Multiple size options for different occasions',
      tags: ['Pure Water', 'Multiple Sizes', 'Daily Hydration']
    },
    {
      id: 5,
      title: 'Custom Branded Bottled Water',
      category: 'custom',
      image: 'https://images.unsplash.com/photo-1544928147-79a2dbc1f389?auto=format&fit=crop&w=800&h=600',
      description: 'Personalized water bottles for businesses and special events',
    ...
    },
    {
      ...
      description: 'Durable products made from recycled plastic waste',
      specifications: 'Various applications',
      options: 'Converting waste into useful products',
      tags: ['Eco-Friendly', 'Sustainable', 'Waste Reduction']
    }
  ];
  ...
  return (
    <section id="products" className="py-20 bg-gradient-to-br from-slate-50 via-white to-amber-50/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          {filters.map((filter) => (
            <button
              ...
              style={{
                backgroundColor: activeFilter === filter.id ? '#B8860B' : undefined,
              }}
              onMouseEnter={(e) => {
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProducts.map((product) => (
            <div 
              key={product.id}
              className="group relative bg-white/60 backdrop-blur-sm rounded-2xl overflow-hidden shadow-lg border border-white/30 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2"
            >
              ...
              <div className="relative z-10 p-6">
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <span className="text-sm text-gray-600">{product.specifications}</span>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <span className="text-sm text-gray-600">{product.options}</span>
                    </div>
                  </div>
                </div>
                ...
                <button 
                  className="w-full text-white py-3 px-6 rounded-xl transition-all duration-300 font-semibold shadow-lg hover:shadow-xl bg-gradient-to-r from-[#2C3E50] to-[#34495E] hover:from-[#B8860B] hover:to-[#D4AF37] hover:scale-105"
                >
                  Learn More
                </button>
              </div>
        ...
        <div className="mt-20">
          <div className="bg-gradient-to-r from-[#2C3E50] to-[#1A252F] rounded-2xl p-8 lg:p-12 text-center">
            <h3 className="text-3xl font-bold text-white mb-8">Production Highlights</h3>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="group">
                ...
                <div className="text-2xl font-bold text-[#B8860B] mb-2">9g-35g</div>
              ...
              <div className="group">
                ...
                <div className="text-2xl font-bold text-[#D4AF37] mb-2">50ml-20L</div>
              ...
              <div className="group">
                ...
                <div className="text-2xl font-bold text-[#B8860B] mb-2">2</div>
                <div className="text-white/90">Water Brands</div>
              </div>
              <div className="group">
