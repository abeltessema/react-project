...
const Services: React.FC = () => {
  const services = [
    {
      ...
      description: 'High-quality PET preforms manufactured to precise specifications for various bottle applications.',
      features: ['9g–35g Weight Range', 'Multiple Neck Sizes', 'Food Grade Quality', 'Custom Specifications'],
      gradient: 'from-[#B8860B] to-[#D4AF37]'
    },
    {
      icon: Package2,
      title: 'Bottle Production',
      description: 'Complete bottle manufacturing from small containers to large capacity bottles with custom branding.',
      features: ['50ml–20L Capacity', 'Various Shapes & Designs', 'Custom Branding Options', 'Food Grade Materials'],
      gradient: 'from-[#2C3E50] to-[#34495E]'
    },
    {
      icon: Droplets,
      title: 'Drinking Water Bottling',
      description: 'Premium water bottling services with advanced purification technology and trusted brand names.',
      features: ['RO Purification', 'UV & Ozone Treatment', 'Aquasafe Brand', 'Intore Brand'],
      gradient: 'from-[#1A252F] to-[#2C3E50]'
    },
    {
      icon: Recycle,
      title: 'Plastic Waste Collection & Recycling',
      description: 'Comprehensive waste management solutions converting plastic waste into durable, reusable products.',
      features: ['Waste Collection Services', 'Advanced Recycling Process', 'Durable Product Creation', 'Environmental Impact'],
  ...
  const processSteps = [
    {
      ...
      description: 'Custom design solutions tailored to your specific requirements'
    },
    {
      icon: Factory,
      title: 'Manufacturing',
      description: 'State-of-the-art production facilities ensuring quality and efficiency'
    },
    {
      icon: ShieldCheck,
  ...
  return (
    <section id="services" className="py-20 bg-gradient-to-br from-slate-50 via-white to-amber-50/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Complete bottling and packaging solutions with eco-friendly practices and premium quality.
          </p>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r ${service.gradient} text-white rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From concept to delivery, we ensure excellence at every step of our manufacturing process
            </p>
          </div>
              ...
              <div key={index} className="text-center group">
                <div className="relative mb-6">
                  ...
                  <div className="absolute -top-2 -right-2 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-md">
                    <span className="text-sm font-bold text-[#B8860B]">{index + 1}</span>
                  </div>
                </div>
        ...
        <div className="text-center">
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 lg:p-12 shadow-lg border border-white/30">
            <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
              Ready to Start Your <span className="text-[#B8860B]">Project</span>?
            </h3>
